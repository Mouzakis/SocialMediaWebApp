 ...
 * @author Petros
 */
public class DeletePostInterface extends HttpServlet {
    User user;
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (Post post : posts) {
                ...
                out.println("<button class=\"view_post\" id='delete' onclick='deletepost(" + post.getPostID()+ "," +"\""+user.getUserName()+"\"" +")'>Delete Post</button>");
                out.println("<button class=\"view_post\" id='update_post' onclick='update_post(" + post.getPostID()+")';>Edit Post</button>");
                out.println("<button class=\"view_post\" id='view_post' onclick='view_post(" +post.getPostID() +")';>View Post</button>");
            }
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(DeletePostInterface.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
